...
extension UIDevice {
    ...
    func ipTest() {
        ...
        case .reachableViaWiFi:
            print("WIFI : \(status.getAddress(for: .wifi) ?? "X")")
        case .reachableViaWWAN:
            print("WWAN : \(status.getAddress(for: .cellular) ?? "X")")
        default:
            break
        }
        print("ipAddress : \(UIDevice().ipAddress() ?? "X")")
        print("Public ipAddress \(UIDevice().getPublicIPAddress())")
    }
}
